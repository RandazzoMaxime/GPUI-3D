...
impl App {
    ...
    fn flush_effects(&mut self) {
        let _t = crate::render_stats::scope("app: flush_effects");
        loop {
    ...
    /// Prêts mutables cumulés sur une entité : inchangé ⇒ son contenu n'a pas pu changer.
    pub fn entity_mutation_count(&self, entity_id: EntityId) -> u64 {
        self.entities.mutation_count(entity_id)
    }
