...
// Compat Helix (voir src/helix_compat.rs) : module nommé plutôt qu'à plat —
// un struct `Copy` exporté à la racine masque `std::marker::Copy` chez tout
// consommateur de `use gpui::*`.
/// Standard edit actions recognized by OS application menus.
