...
pub use geometry::*;
pub use global::*;
// Compat Helix (voir helix_compat.rs) : le fork gpui perdu re-exportait
// accesskit ; WGPUI n'a pas de backend a11y, seuls les types sont exposés.
pub use accesskit;
pub use accesskit::{Action as AccessibleAction, Orientation, Role, Toggled};
pub use helix_compat::*;
pub use present_mode::{supported_present_modes, window_present_mode, WindowPresentMode};
...
// Compat Helix (voir helix_compat.rs) : partage du device wgpu du renderer
