...
impl Interactivity {
    ...
    /// Compat (voir src/compat.rs) : clics « auxiliaires »
...
pub trait InteractiveElement: Sized {
    ...
    // Compat (voir src/compat.rs) : API d'accessibilité du fork
...
pub trait StatefulInteractiveElement: InteractiveElement {
    ...
    /// Compat (voir src/compat.rs) : verrouille le scroll molette
    ...
    /// Compat (voir src/compat.rs) : équivalent fluent de
...
impl Interactivity {
    ...
    fn paint_mouse_listeners(
        ...
        if let Some(element_state) = element_state {
            ...
            // Compat (voir src/compat.rs) : clic auxiliaire =
