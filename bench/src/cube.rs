//! Copie du moteur de GPUI-WGPU : la 3D qui tourne derrière l'UI en mode `overlay`.

use gpui3d_shell::{CLEAR_COLOR, CUBE_INDICES, CUBE_VERTICES, Renderer, Scene, Surface};
...
impl Renderer for WgpuCube {
    fn new(surface: &Surface) -> Self {
        ...
        let shader = device.create_shader_module(wgpu::include_wgsl!("../../GPUI-WGPU/src/cube.wgsl"));
